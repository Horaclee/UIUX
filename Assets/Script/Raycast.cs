...
public class RayCast : MonoBehaviour
{
    ...
    private void InteractableOject()
    {
        ...
        Plate plate = hitObject.GetComponentInChildren<Plate>();
        Knife knife = hitObject.GetComponentInChildren<Knife>();
        Stove stove = hitObject.GetComponentInChildren<Stove>();
